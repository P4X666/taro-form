...
type InputFunction<T extends string | number, U = any, R = void> = (
  value: T,
  event?: BaseEventOrig<U>
) => R

type InputBaseEventDetail = {
  /** 输入值 */
  value: string | number
}
...
export interface AtInputProps extends AtComponent, OmitInputProps {
   ...
   */
  onBlur?: InputFunction<string | number, InputBaseEventDetail>
  /**
   ...
   */
  onConfirm?: InputFunction<string | number, InputBaseEventDetail>
  /**
